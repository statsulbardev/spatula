@switch ($name)
    @case('arrow-down-on-square-stack-solid')
    ...
    @case('arrow-down-on-square-stack-outline')
    ...
    @case('clipboard-document-list-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $size }}">
            <path fill-rule="evenodd"
    ...
    @case('clipboard-document-list-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $size }}">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @case('cursor-arrow-ripple-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $size }}">
            <path fill-rule="evenodd"
    ...
    @case('cursor-arrow-ripple-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $size }}">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @case('presentation-chart-line-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $size }}">
            <path fill-rule="evenodd"
    ...
    @case('presentation-chart-line-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $size }}">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    @case ('magnifying-glass-circle-solid')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $size }}">
    ...
    @case('magnifying-glass-circle-outline')
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="{{ $size }}">
            <path fill-rule="evenodd"
    ...
    @case('square-3-stack-3d-outline')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="{{ $size }}">
            <path stroke-linecap="round" stroke-linejoin="round"
