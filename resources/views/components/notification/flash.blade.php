<div class="pointer-events-none fixed inset-0 flex items-end justify-center px-4 py-6 sm:items-start sm:justify-end sm:p-6 z-10">
        ...
        <div class="shadow-xs overflow-hidden rounded-lg">
            <div class="p-4">
                <div class="flex items-center">
                    <div class="flex-shrink-0 text-primary-400">
                        @include('components.icon', ['name' => 'information-circle', 'size' => 'w-6 h-6'])
                    </div>
