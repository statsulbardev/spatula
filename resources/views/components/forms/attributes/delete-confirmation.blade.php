...
<div wire:ignore data-te-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none bg-black bg-opacity-60"
    ...
    <div data-te-modal-dialog-ref
        ...
        <div
            ...
            <div
                ...
                <!--Modal title-->
                <h5 class="text-primary text-xl font-medium leading-normal" id="exampleModalScrollableLabel">Konfirmasi
                    Hapus Data</h5>
                <!--Close button-->
                <button type="button"
