{{-- Menu Aplikasi --}}
<div class="h-screen px-4 space-y-5">
    <!-- SideBar Toggle -->
    <button
    ...
    <div x-data="dropdown" class="relative">
        <!-- Dropdown head -->
        <div
            @click="toggle('tindak-lanjut')"
            @click="$store.sidebar.active = 'tindak-lanjut'"
            x-data="tooltip"
            x-on:mouseover="show = true"
            x-on:mouseleave="show = false"
            class="flex justify-between text-gray-400 hover:text-gray-200 hover:bg-primary-600 items-center space-x-2 rounded-md p-2 cursor-pointer"
            x-bind:class="{'justify-start': $store.sidebar.full, 'sm:justify-center':!$store.sidebar.full, 'text-gray-200 bg-primary-600':$store.sidebar.active == 'tindak-lanjut','text-gray-400 ':$store.sidebar.active != 'tindak-lanjut'}">
    ...
    <div x-data="dropdown" class="relative">
        ...
        <div
            x-cloak
            x-show="open" @click.outside="open = false" x-bind:class="$store.sidebar.full ? expandedClass : shrinkedClass" class="text-gray-400 space-y-3">
            <h1 class="hover:text-gray-200 cursor-pointer">
