                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4 class="d-flex align-items-center">
                                <img width="5%" class="mr-2" src="{{ asset('files/logo/bps.svg') }}" alt="">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('penilaian.petugas.store', ['satker' => $kantor->kode_satker]) }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">
                                        Tuliskan Saran/Pengaduan/Apresiasi <sup class="border border-danger rounded p-1 text-danger">Wajib</sup>
                                    </label>
                                    <div class="col-sm-9">
