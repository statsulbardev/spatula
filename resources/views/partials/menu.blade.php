{{-- Dashbboard --}}
<div class="mb-8">
    <a class="group flex cursor-pointer items-center" href="{{ route('dashboard') }}">
        <div class="{{ request()->is('dashboard') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} mr-2 h-4 w-4">
...
@role('superadmin|admin|pj-layanan|pj-pengaduan')
    <div class="mb-8 cursor-pointer" x-data="{ visible: false }">
        <div class="group flex items-center pb-1" @click="visible = true">
            <div class="{{ request()->is('verifikasi/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} mr-2 h-4 w-4">
                @include('components.icon', ['name' => 'rectangle-stack', 'size' => 'w-4 h-4'])
            </div>
            <div
                class="{{ request()->is('verifikasi/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} w-7/12 text-sm font-medium tracking-wider">
                Verifikasi
            </div>
            <div class="{{ request()->is('verifikasi/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} h-4 w-4"
                x-show="!visible">
        ...
        <ul x-show="visible" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90"
            x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-300"
            x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" @click.away="visible = false">
...
@role('superadmin|admin|pimpinan')
    <div class="mb-8 cursor-pointer" x-data="{ visible: false }">
        <div class="group flex items-center pb-1" @click="visible = true">
            <div class="{{ request()->is('laporan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} mr-2 h-4 w-4">
                @include('components.icon', ['name' => 'presentation-chart', 'size' => 'w-4 h-4'])
            </div>
            <div
                class="{{ request()->is('laporan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} w-7/12 text-sm font-medium tracking-wider">
                Laporan
            </div>
            <div class="{{ request()->is('laporan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} h-4 w-4" x-show="!visible">
                @include('components.icon', ['name' => 'chevron-right', 'size' => 'w-4 h-4'])
            </div>
            <div class="{{ request()->is('laporan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} h-4 w-4" x-show="visible">
                @include('components.icon', ['name' => 'chevron-down', 'size' => 'w-4 h-4'])
...
@role('superadmin')
    <div class="mb-6 cursor-pointer" x-data="{ visible: false }">
        <div class="group flex items-center pb-1" @click="visible = true">
            <div class="{{ request()->is('pengaturan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} mr-2 h-4 w-4">
                @include('components.icon', ['name' => 'cog', 'size' => 'w-4 h-4'])
            </div>
            <div
                class="{{ request()->is('pengaturan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} w-7/12 text-sm font-medium tracking-wider">
                Pengaturan
            </div>
            <div class="{{ request()->is('pengaturan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} h-4 w-4"
                x-show="!visible">
                @include('components.icon', ['name' => 'chevron-right', 'size' => 'w-4 h-4'])
            </div>
            <div class="{{ request()->is('pengaturan/*') ? 'text-white' : 'text-primary-100 group-hover:text-white' }} h-4 w-4"
        ...
        <ul x-show="visible" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90"
            ...
            <li class="group flex items-center space-y-2">
                <span class="mr-2 h-4 w-4"></span>
                <a class="{{ request()->is('pengaturan/layanan') || request()->is('pengaturan/layanan/*')
                    ? 'text-white'
            ...
            <li class="group flex items-center space-y-2">
                <span class="mr-2 h-4 w-4"></span>
                <a class="{{ request()->is('pengaturan/pengguna') || request()->is('pengaturan/pengguna/*')
                    ? 'text-white'
                    : 'text-primary-100 group-hover:text-white' }} text-sm"
            ...
            <li class="group flex items-center space-y-2">
                <span class="mr-2 h-4 w-4"></span>
                <a class="{{ request()->is('pengaturan/satker') || request()->is('pengaturan/satker/*')
                    ? 'text-white'
                    : 'text-primary-100 group-hover:text-white' }} text-sm"
