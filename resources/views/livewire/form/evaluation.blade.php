...
<div>
    ...
    <form wire:submit.prevent="submitData">
        <div class="bg-white border-r border-t border-l border-gray-200 shadow-sm rounded-t-lg mt-4 py-4">
            <div class="py-10 px-12 text-center">
                ...
                <h1 class="mt-2 lg:text-4xl sm:text-2xl font-extrabold">Saran Pengaduan Online dan Rating Petugas Layanan
                </h1>
                <p class="mt-5 lg:text-lg sm:text-xs text-zinc-500">Anda dapat memberikan penilaian terhadap petugas dan
    ...
    <button id="notification_button" data-te-toggle="modal" data-te-target="#saveModal" data-te-ripple-init
        data-te-ripple-color="light" hidden></button>
    <div wire:ignore data-te-modal-init
        class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
        id="saveModal" tabindex="-1" aria-labelledby="saveModalTitle" aria-modal="true" role="dialog">
        <div data-te-modal-dialog-ref
            ...
            <div
                ...
                <div
                    ...
                    <!--Modal title-->
                    <h5 class="text-xl font-medium leading-normal text-primary" id="exampleModalScrollableLabel">
                        Notifikasi</h5>
                    <!--Close button-->
                    <button type="button"
