...
<div>
    ...
    <section class="mt-10 mb-6">
        <div class="w-full bg-white rounded shadow">
            ...
            @else
                <div class="border-collapse overflow-x-scroll">
                    <table class="table-fixed oveflow-hidden whitespace-nowrap">
                        <thead>
                            <tr class="text-left font-bold bg-neutral-100">
                                <th class="px-6 pt-6 pb-4">
                                    <input type="checkbox" class="h-5 w-5" wire:model="selectAll">
                                </th>
                                <th class="px-6 pt-6 pb-4 sticky">Tanggal</th>
                                <th class="px-6 pt-6 pb-4 sticky">Pengguna Layanan</th>
                                <th class="px-6 pt-6 pb-4 sticky">Email</th>
                                <th class="px-6 pt-6 pb-4 sticky">No. Telp/Whatsapp</th>
                                <th class="px-6 pt-6 pb-4 sticky">Saran dan Pengaduan</th>
                                <th class="px-6 pt-6 pb-4 sticky">Jenis Layanan</th>
                                <th class="px-6 pt-6 pb-4 sticky">Rating Layanan</th>
                                <th class="px-6 pt-6 pb-4 sticky">Nama Petugas</th>
                                <th class="px-6 pt-6 pb-4 sticky">Rating Petugas</th>
                                <th class="px-6 pt-6 pb-4 sticky">Kategori</th>
                                <th class="px-6 pt-6 pb-4 sticky"></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($services as $service)
                                <tr class="hover:bg-gray-200 focus-within:bg-grey-lightest">
                                    ...
                                    <td class="border-t">
                                        <span class="pl-6 py-4">
                                            {{  $service->email_konsumen }}
                                        </span>
                                    </td>
                                    {{-- No. WA/Telepon --}}
                                    <td class="border-t">
                                        <span class="pl-6 py-4">
                                            {{ $service->no_wa_telepon ?? '-' }}
                                        </span>
                                    </td>
                                    {{-- Saran Pengaduan --}}
                                    <td class="border-t">
                                    ...
                                    <td class="border-t">
                                        <span class="pl-6 py-4">
                                            {{ $service->layanan->nama_layanan }}
                                        </span>
                                    </td>
                                    {{-- Rating Layanan --}}
                                    <td class="border-t">
                                        <span class="flex pl-6 py-4">
