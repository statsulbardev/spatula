...
<div>
    {{-- Header --}}
    @include('components.page.page-title', ['title' => 'Konfirmasi PJ Layanan'])
                            ...
                            <tr class="hover:bg-gray-200 focus-within:bg-grey-lightest">
                                ...
                                <td class="border-t">
                                    <span class="pl-6 py-4 items-center">
                                        <i class="fas fa-calendar opacity-50 text-sm"></i> {{ DateFormat::convertDateTime($service->created_at) }}
                                ...
                                <td class="border-t" width="45%">
                                    <span class="pl-6 py-4 flex items-center">
                                        {{ Str::limit($service->saran_pengaduan, 100) }}
                                    </span>
                                </td>
                                <td class="border-t">
                                    <span class="pl-6 py-4">
                                ...
                                <td class="border-t w-px">
                                    <span class="py-2 flex items-center space-x-2 mr-2">
                                        @if(!is_null($service->kode_saran))
                                            <a class="text-purple-400 hover:text-purple-500"
                                        ...
                                        @endif
                                        <button class="text-secondary-400 hover:text-secondary-500">
