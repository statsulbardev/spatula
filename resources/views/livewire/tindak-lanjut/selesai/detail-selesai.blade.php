...
<div>
    ...
    <h1 class="mb-8 font-bold text-3xl">
        <a href="{{  url(env('APP_URL') . '/tindak-lanjut/selesai') }}" class="text-primary-500">Selesai Tindak Lanjut / </a>
        <span>{{ $done->nama_konsumen }} ({{ $done->layanan->nama_layanan }})</span>
    </h1>
                        ...
                        <table class="table-auto w-full">
                            <tbody class="text-sm divide-y divide-gray-100">
                                <tr>
                                    ...
                                    <td>{{ DateFormat::convertDateTime($done->created_at) }}</td>
                                </tr>
                                <tr>
