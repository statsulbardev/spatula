                            ...
                            <tr class="hover:bg-gray-200 focus-within:bg-grey-lightest">
                                ...
                                <td class="border-t" width="35%">
                                    <div
                                        ...
                                        x-init="originalContent = @js($report->saran_pengaduan).trim(); content = originalContent.slice(0, maxLength)"
                                                ...
                                                @for($i = 0; $i < 5; $i++)
                                                    @if($i < $report->rating_layanan)
                                                        <span class="text-secondary-400 {{ $i == 0 ?: 'ml-2' }}">
                                                            @include('components.icon', ['name' => 'star-solid', 'size' => 'w-4 h-4'])
                                                        </span>
                                                    @else
                                                        <span class="text-secondary-400 {{ $i == 0 ?: 'ml-2' }}">
                                                            @include('components.icon', ['name' => 'star-outline', 'size' => 'w-4 h-4'])
                                                        </span>
                                                    @endif
                                                @endfor
                                            @else
                                ...
                                <td class="border-t">
                                    <span class="pl-6 py-4 items-center">
                                        <i class="fas fa-calendar opacity-50 text-sm"></i> {{ $report->tanggal_selesai->format('d/m/Y') }}
                                    </span>
                                </td>
                            </tr>
                        @endforeach
