...
<div>
    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
            <div class="flex flex-row rounded bg-white p-4 shadow">
                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100">
                    <span class="h-6 w-6 fill-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 431.497 431.498">
                            <g>
                                <path
                ...
                <div class="ml-4 flex flex-grow flex-col">
                    ...
                    <div class="mt-2 text-lg font-bold">{{ $petugasAktif }}</div>
                </div>
            </div>
        </div>
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
            <div class="flex flex-row rounded bg-white p-4 shadow">
                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-green-100">
                    <span class="h-6 w-6 fill-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                ...
                <div class="ml-4 flex flex-grow flex-col">
                    ...
                    <div class="mt-2 text-lg font-bold">150 <small>dari</small> 214 unit</div>
                </div>
            </div>
        </div>
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
            <div class="flex flex-row rounded bg-white p-4 shadow">
                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-red-100">
                    <span class="h-6 w-6 fill-red-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                ...
                <div class="ml-4 flex flex-grow flex-col">
                    ...
                    <div class="mt-2 text-lg font-bold">6 <small>dari</small> 214 <small>unit</small></div>
                </div>
            </div>
        </div>
        <div class="col-span-12 sm:col-span-6 md:col-span-3">
            <div class="flex flex-row rounded bg-white p-4 shadow">
                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-red-100">
                    <span class="h-6 w-6 fill-orange-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 360.574 360.574">
                            <g>
                                <path
                ...
                <div class="ml-4 flex flex-grow flex-col">
                    ...
                    <div class="mt-2 text-lg font-bold">0 <small>tiket</small></div>
                </div>
            </div>
        </div>
    </div>
