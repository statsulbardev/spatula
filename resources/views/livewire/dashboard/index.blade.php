...
<div>
    <h1 class="mb-8 font-bold text-3xl text-neutral-700">Dashboard ITValet</h1>
            ...
            <div class="flex flex-row bg-white shadow rounded p-4">
                <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-lg bg-blue-100">
                    <span class="w-6 h-6 fill-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 431.497 431.498"><g><path d="M10.107,111.108h308.148c5.544,0,10.019-4.483,10.019-10.016V10.016C328.274,4.486,323.8,0,318.256,0H10.107 C4.569,0,0.091,4.486,0.091,10.016v91.076C0.091,106.625,4.569,111.108,10.107,111.108z M32.66,26.675h131.523v52.609H32.66V26.675 z M328.28,193.232v-48.87c0-5.533-4.48-10.019-10.013-10.019H10.107c-5.539,0-10.016,4.486-10.016,10.019v91.076 c0,5.532,4.478,10.024,10.016,10.024h186.898v-16.497c0-19.709,16.027-35.733,35.734-35.733H328.28z M164.183,212.276H32.66 v-52.609h131.523V212.276z M0.091,277.416v91.073c0,5.533,4.478,10.019,10.016,10.019h186.898V267.403H10.107 C4.569,267.403,0.091,271.883,0.091,277.416z M32.66,296.649h131.523v52.612H32.66V296.649z M414.4,214.416L414.4,214.416H241.546 c-8.026,0-14.552,6.522-14.552,14.549v155.081h0.047c0.236,2.518,2.275,4.479,4.8,4.479c2.523,0,4.574-1.962,4.806-4.479h0.047 V228.971c0-2.672,2.181-4.847,4.853-4.847h148.798c2.672,0,4.858,2.163,4.858,4.847v187.975c0,2.671-2.181,4.847-4.858,4.847 h-19.399c-1.785-0.757-8.949-4.161-8.949-9.422c0-6.053,9.334-9.8,9.41-9.836c2.193-0.827,3.487-3.097,3.062-5.402 c-0.414-2.317-2.418-3.995-4.765-3.995H232.16c-10.545,0-19.122,8.576-19.122,19.115c0,10.545,8.577,19.127,19.122,19.127h132.306 c-0.012,0.035-0.012,0.077-0.023,0.118h25.901c8.015,0,14.546-6.525,14.546-14.552V230.768c0.077-6.833,8.382-6.655,9.321-6.655 h0.042c4.107,0,7.453,3.352,7.453,7.459c0,4.114-3.346,7.454-7.453,7.454c-2.678,0-4.853,2.169-4.853,4.853 s2.175,4.847,4.853,4.847c9.463,0,17.153-7.695,17.153-17.153C431.406,222.103,423.716,214.416,414.4,214.416z M355.293,421.668 H232.16c-5.19,0-9.422-4.227-9.422-9.416c0-5.195,4.231-9.422,9.422-9.422h123.269c-1.85,2.601-3.139,5.757-3.139,9.528 C352.302,416.047,353.52,419.138,355.293,421.668z"></path></g></svg>
                    </span>
                </div>
            ...
            <div class="flex flex-row bg-white shadow rounded p-4">
                <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-lg bg-green-100">
                    <span class="w-6 h-6 fill-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-thumbs-up"><path class="primary" d="M13 4.8l2.92 6.8a1 1 0 0 1 .08.4v8a2 2 0 0 1-2 2H8a4.28 4.28 0 0 1-3.7-2.45L2.07 14.4A1 1 0 0 1 2 14v-2a3 3 0 0 1 3-3h4V5a3 3 0 0 1 3-3 1 1 0 0 1 1 1v1.8z"></path><rect width="4" height="11" x="18" y="11" class="secondary" rx="1"></rect></svg>
                    </span>
                </div>
                <div class="flex flex-col flex-grow ml-4">
            ...
            <div class="flex flex-row bg-white shadow rounded p-4">
                <div class="flex items-center justify-center flex-shrink-0 h-12 w-12 rounded-lg bg-red-100">
                    <span class="w-6 h-6 fill-red-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-thumbs-down"><path class="primary" d="M11 19.2l-2.92-6.8A1 1 0 0 1 8 12V4c0-1.1.9-2 2-2h6c1.5 0 3.11 1.06 3.7 2.45l2.22 5.16A1 1 0 0 1 22 10v2a3 3 0 0 1-3 3h-4v4a3 3 0 0 1-3 3 1 1 0 0 1-1-1v-1.8z"></path><rect width="4" height="11" x="2" y="2" class="secondary" rx="1" transform="rotate(180 4 7.5)"></rect></svg>
