                                ...
                                <td class="border-t">
                                    <span class="pl-6 py-4 flex items-center">
                                        @foreach ($user->roles as $index => $role)
                                            <div
                                                class="{{ $index == 0 ?: 'ml-1' }} relative inline-block px-3 py-1 text-sm text-green-900 leading-tight">
                                                <span aria-hidden
                                ...
                                <td class="border-t w-px">
                                    <span class="py-2 flex items-center space-x-2 mr-2">
                                        ...
                                        <button wire:click="deleteItem({{ $user->id }})" type="button" x-data
                                            x-tooltip.raw="Hapus Pengguna" class="text-red-500 hover:text-red-600"
