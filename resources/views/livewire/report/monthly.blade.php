        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header d-inline-flex align-items-center">
                    <form wire:submit.prevent="detail" class="d-inline-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">Laporan Bulanan Rating Petugas Layanan Tahun {{ $tahun }}</div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">Laporan Bulanan Saran Pengaduan Tahun {{ $tahun }}</div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">Laporan Bulanan Rating Layanan Tahun {{ $tahun }}</div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            <thead>
