document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('dropdown', () => ({
        ...
        shrinkedClass: 'sm:absolute top-0 left-16 sm:shadow-md sm:z-10 sm:bg-gray-900/40 sm:rounded-md sm:p-4 border-l sm:border-none border-gray-400 ml-4 pl-4 sm:ml-0 w-56 backdrop-blur-2xl text-white text-sm'
    }));
    // Creating tooltip
    Alpine.data('tooltip', () => ({
        show: false,
